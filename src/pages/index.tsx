...
function HomePage(): ReactNode {
  return (
    ...
    <div style={{ minHeight: '100vh' }} className="bg-background">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', gap: '4rem', alignItems: 'start' }}>
          ...
          <div style={{ minWidth: '300px', position: 'sticky', top: '4rem' }}>
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <p style={{ fontSize: '1.25rem', color: '#9CA3AF', marginBottom: '1.5rem', lineHeight: '1.6' }}>
              ...
              <a
                ...
                style={{ color: '#9CA3AF', marginBottom: '2rem', display: 'block', textDecoration: 'none' }}
              ...
              <div style={{ display: 'flex', gap: '1rem', justifyContent: 'flex-start' }}>
                <a href="mailto:swiftobjc@gmail.com" aria-label="Email" style={{ display: 'inline-flex', color: '#9CA3AF' }}>
          ...
          <div>
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', color: '#9CA3AF', lineHeight: '1.75' }}>
                <p>
      ...
      <footer style={{ borderTop: '1px solid #E5E7EB', marginTop: '3rem' }}>
